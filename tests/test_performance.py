...
class TestPerformanceBenchmarks(unittest.TestCase):
    ...
    def test_validation_performance(self):
        ...
        start = time.time()
        for i in range(1000):
            self.tdsr._validateInteger(i % 100, 0, 100, 50, "test")
        elapsed = time.time() - start
...
class TestRegressionPrevention(unittest.TestCase):
    ...
    def test_validation_boundary_regression(self):
        ...
        # At boundaries
        self.assertEqual(self.tdsr._validateInteger(0, 0, 10, 5, "test"), 0)
        self.assertEqual(self.tdsr._validateInteger(10, 0, 10, 5, "test"), 10)

        # Outside boundaries
        self.assertEqual(self.tdsr._validateInteger(-1, 0, 10, 5, "test"), 5)
        self.assertEqual(self.tdsr._validateInteger(11, 0, 10, 5, "test"), 5)

    def test_selection_size_validation_regression(self):
        """Regression test: Selection size validation must work correctly."""
        # Valid selection
        valid, msg = self.tdsr._validateSelectionSize(1, 100, 1, 80)
        self.assertTrue(valid, "Valid selection should pass")
        self.assertIsNone(msg, "Valid selection should have no error message")

        # Exceeds row limit
        invalid_rows, msg_rows = self.tdsr._validateSelectionSize(1, 10001, 1, 80)
        ...
        invalid_cols, msg_cols = self.tdsr._validateSelectionSize(1, 100, 1, 1001)
    ...
    def test_string_truncation_regression(self):
        ...
        long_string = "a" * 100
        result = self.tdsr._validateString(long_string, 50, "default", "test")
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_validate_integer_with_float(self):
        ...
        result = self.tdsr._validateInteger(5.7, 0, 10, 5, "test")
    ...
    def test_validate_integer_with_none(self):
        ...
        result = self.tdsr._validateInteger(None, 0, 10, 5, "test")
    ...
    def test_validate_string_with_none(self):
        ...
        result = self.tdsr._validateString(None, 10, "default", "test")
    ...
    def test_validate_selection_with_negative_coordinates(self):
        ...
        valid, msg = self.tdsr._validateSelectionSize(-5, 5, -10, 10)
    ...
    def test_empty_punctuation_sets(self):
        ...
        punct_none = self.tdsr.PUNCTUATION_SETS[self.tdsr.PUNCT_NONE]
