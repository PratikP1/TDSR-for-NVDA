...
class TestValidationFunctions(unittest.TestCase):
    ...
    def test_validate_string_empty(self):
        ...
        result = self.tdsr._validateString("", 10, "default", "test_field")
        self.assertEqual(result, "")

    def test_validate_string_invalid_type(self):
        """Test _validateString with invalid type."""
        result = self.tdsr._validateString(None, 10, "default", "test_field")
    ...
    def test_validate_selection_size_max_rows_boundary(self):
        ...
        is_valid, msg = self.tdsr._validateSelectionSize(1, 10000, 1, 80)
        self.assertTrue(is_valid)
        self.assertIsNone(msg)
    ...
    def test_validate_selection_size_max_cols_boundary(self):
        ...
        is_valid, msg = self.tdsr._validateSelectionSize(1, 100, 1, 1000)
        self.assertTrue(is_valid)
        self.assertIsNone(msg)
    ...
    def test_validate_selection_size_reversed_rows(self):
        ...
        is_valid, msg = self.tdsr._validateSelectionSize(100, 1, 1, 80)
        self.assertTrue(is_valid)
        self.assertIsNone(msg)

    def test_validate_selection_size_reversed_cols(self):
        """Test _validateSelectionSize with reversed column order."""
        is_valid, msg = self.tdsr._validateSelectionSize(1, 100, 80, 1)
        self.assertTrue(is_valid)
        self.assertIsNone(msg)
...
class TestResourceLimits(unittest.TestCase):
    ...
    def test_max_selection_rows_defined(self):
        ...
        self.assertTrue(hasattr(self.tdsr, 'MAX_SELECTION_ROWS'))
        self.assertEqual(self.tdsr.MAX_SELECTION_ROWS, 10000)

    def test_max_selection_cols_defined(self):
        """Test MAX_SELECTION_COLS constant is defined."""
        self.assertTrue(hasattr(self.tdsr, 'MAX_SELECTION_COLS'))
        self.assertEqual(self.tdsr.MAX_SELECTION_COLS, 1000)

    def test_max_window_dimension_defined(self):
        """Test MAX_WINDOW_DIMENSION constant is defined."""
        self.assertTrue(hasattr(self.tdsr, 'MAX_WINDOW_DIMENSION'))
        self.assertEqual(self.tdsr.MAX_WINDOW_DIMENSION, 10000)

    def test_max_repeated_symbols_length_defined(self):
        """Test MAX_REPEATED_SYMBOLS_LENGTH constant is defined."""
        self.assertTrue(hasattr(self.tdsr, 'MAX_REPEATED_SYMBOLS_LENGTH'))
        self.assertEqual(self.tdsr.MAX_REPEATED_SYMBOLS_LENGTH, 50)
